...
`AGENTS.md` è il contratto canonico. In sintesi: leggi `docs/PROJECT.md`, lavora test-first, usa solo le recipe `just`, chiudi con `just prepush` verde e un report con output verbatim.
...
Regole di dettaglio: [`docs/development/CODING.md`](./docs/development/CODING.md) e [`docs/development/TESTING.md`](./docs/development/TESTING.md).
